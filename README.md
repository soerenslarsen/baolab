...
Important note: ISHAPE gives wrong results when compiled with gcc13 (at least on MacOS). For now, the workaround is to either use clang or older versions of gcc (gcc9 works fine, I haven't tested other versions).
